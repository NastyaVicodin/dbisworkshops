...
class User:
    ...
    def register(self, p_id_code, p_last_name, p_first_name,  p_email, p_login, p_salary, p_specialization, p_location, p_sphere, p_password):
        status = self.__cursor.var(cx_Oracle.STRING)
    ...
    def update(self, p_id_code, p_last_name, p_first_name, p_email, p_login, p_salary, p_specialization, p_location, p_sphere):
        status = self.__cursor.var(cx_Oracle.STRING)
    ...
    def update_password(self, p_id_code, p_old_password, p_new_password):
        ...
        self.__cursor.callproc("user_package.edit_user_info", [status, p_id_code, None, None, None,
                                                               None, None, None, None, None, p_old_password, p_new_password])
        return status.values[0]
